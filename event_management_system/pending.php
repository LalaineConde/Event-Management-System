<?php
    ...
    $display_pending = "SELECT * FROM events_details WHERE status = 'PENDING'";
    $query = mysqli_query($connection, $display_pending);
...
<?php
    ...
    while ($row = mysqli_fetch_assoc($query)) {
        $event_id = $row['event_id']; // Fetch the event_id from the row
    ...
    <section class="container1">
        <div class="pending_container" style="border: 3px solid gray; background: <?php echo $backgroundColor; ?>">
            <div class="left-content">
                ...
                <a href="edit-event.php?event_id=<?php echo $event_id; ?>&status=PENDING">EDIT</a>
                <a href="delete-event.php?event_id=<?php echo $event_id; ?>&status=PENDING">DELETE</a>
            </div>
            ...
            <div class="right-content">
                ...
                <a href="confirmed.php?event_id=<?php echo $event_id; ?>">CONFIRM</a>
